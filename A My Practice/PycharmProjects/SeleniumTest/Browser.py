...
# list1=driver.find_elements_by_class_name('style-scope ytd-section-list-renderer')
# for ele in list1:
#     ele.find_element(By.XPATH,'.//*[@title="Automation Testing Tutorial for Beginners"]').click()
#driver.find_element(By.XPATH, './/*[@title="Automation Testing Tutorial for Beginners"]').click()
